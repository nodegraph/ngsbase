...
class DEVICE_EXPORT Buffer {
 public:
  ...
  // Loading.
  virtual void load_null(size_t num_bytes) {load(num_bytes,NULL);}
  virtual void load(size_t num_bytes, const void* data);
  virtual void load_subsection(size_t offset, size_t num_bytes, const void* data) const;
