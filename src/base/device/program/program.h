...
class DEVICE_EXPORT Program {
 public:
  Program(const std::string& vertex_source, const std::string& fragment_source, const std::string& geometry_source);
  virtual ~Program();
  ...
  // Information about the program (default/block uniforms, attributes and frag data).
 ...
 private:
  ...
  // Helpers which give us information about the programs.
